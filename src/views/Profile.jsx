...
export default function Profile() {
  ...
  // Si por alguna razón no hay usuario (protección extra)
  if (!user) {
    return (
  ...
  // Filtramos el catálogo global para que muestre SOLO tus juegos
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 mb-8 flex flex-col sm:flex-row items-center gap-4 shadow-xl">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="text-sm text-slate-400 mt-0.5">Sesión activa:</p>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl">
        ...
        {myGames.length === 0 ? (
          <div className="text-center py-12 border-2 border-dashed border-slate-800 rounded-xl">
            <p className="text-slate-500 text-sm">Aún no has agregado juegos con esta cuenta.</p>
            <p className="text-xs text-slate-600 mt-1">Usa la opción "Vender Juego" en el menú para añadir uno.</p>
          </div>
        ) : (
                  ...
                  <tr key={game.id} className="hover:bg-slate-800/30 transition-colors">
                    ...
                    <td className="py-4 px-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 sm:hidden capitalize">{game.category || game.consola}</p>
                      </div>
                    </td>
                    {/* Categoría / Consola */}
